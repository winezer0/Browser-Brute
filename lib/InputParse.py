...
class ParserCmd(object):
    ...
    def my_parser(self):
        ...
        parser.add_argument("-bp", "--browser_proxy",
                            help="Specifies the Browser Proxy IP for HTTP or HTTPS , eg: http://127.0.0.1:8080",default=None)  # 指定浏览器代理服务器地址
        parser.add_argument("-bua", "--browser_useragent",
                            help="Specifies the Browser UserAgent , eg: Mozilla/5.0 Version/4.0",  default=None)  # 指定浏览器User Agent头
        parser.add_argument("-bud", "--browser_user_dir",
                            help="Specifies the Browser User Dir , eg: D:\temp\Chrome User Data",default=None)  # 指定浏览器用户数据目录
        parser.add_argument("-bcp", "--browser_chrome_path",
                            help="Specifies the Browser Chrome.exe Path , eg: C:\chrome\chrome.exe",default=None)  # 指定浏览器chrome.exe路径
        parser.add_argument("-bdp", "--browser_driver_path",
                            help="Specifies the Browser Driver Path, eg: D:\temp\chromedriver.exe", default=None)  # 指定浏览器chromedriver.exe路径
